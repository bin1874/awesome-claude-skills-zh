...
description: 下载 YouTube 视频，可自定义质量和格式选项。当用户要求下载、保存或抓取 YouTube 视频时使用此技能。支持各种质量设置（最佳、1080p、720p、480p、360p）、多种格式（mp4、webm、mkv）以及仅音频 MP3 下载。
---
...
这将以最佳可用质量下载 MP4 视频到 `/mnt/user-data/outputs/`。
