...
- [Brand Guidelines](./brand-guidelines/) - 将 Anthropic 官方品牌颜色和字体应用到 artifacts，确保一致的视觉识别和专业的设�标准。
...
通过 [Rube MCP (Composio)](https://composio.dev) 为 78 个 SaaS 应用提供的预构建工作流技能。每个技能包含工具序列、参数指导、已知陷阱和快速参考表 — 全部使用从 Composio API 发现的真实工具 slugs。
...
**项目管理**
- [Asana Automation](./asana-automation/) - 自动化 Asana：任务、项目、分区、分配和工作区。
...
- [Todoist Automation](./todoist-automation/) - 自动化 Todoist：任务、项目、分区、标签和过滤器。
...
- [PagerDuty Automation](./pagerduty-automation/) - 自动化 PagerDuty：事件、服务、调度、升级策略和值班。
...
- [Supabase Automation](./supabase-automation/) - 自动化 Supabase：SQL 查询、表结构、Edge Functions 和存储。
...
**电子表格与数据库**
- [Airtable Automation](./airtable-automation/) - 自动化 Airtable：记录、表、基地、视图和字段管理。
...
- [Google Calendar Automation](./google-calendar-automation/) - 自动化 Google Calendar：事件、参与者、空闲/忙碌和周期日程。
- [Outlook Calendar Automation](./outlook-calendar-automation/) - 自动化 Outlook Calendar：事件、参与者、提醒和周期日程。
...
- [Reddit Automation](./reddit-automation/) - 自动化 Reddit：帖子、评论、子版块、投票和审核。
...
- [Klaviyo Automation](./klaviyo-automation/) - 自动化 Klaviyo：资料、列表、细分、营销活动和事件。
- [Mailchimp Automation](./mailchimp-automation/) - 自动化 Mailchimp：受众、营销活动、模板、细分和报告。

**支持与帮助台**
- [Freshdesk Automation](./freshdesk-automation/) - 自动化 Freshdesk：工单、联系人、客服、组和预设回复。
...
- [Miro Automation](./miro-automation/) - 自动化 Miro：画板、便签、形状、连接器和项目。
...
- [PostHog Automation](./posthog-automation/) - 自动化 PostHog：事件、用户、功能开关、洞察和注释。
- [Segment Automation](./segment-automation/) - 自动化 Segment：来源、目标、追踪和数据仓库连接。
