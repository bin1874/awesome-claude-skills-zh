...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Skills-30+-orange.svg?style=flat-square" alt="Skills: 30+" />
</p>
...
> 📖 本项目是 [awesome-claude-skills](https://github.com/ComposioQ/awesome-claude-skills) 的中文翻译版本，最后同步于 2025年4月
>
> 💡 中文版 GitHub Pages 站点：[https://lessup.github.io/awesome-claude-skills-zh](https://lessup.github.io/awesome-claude-skills-zh)


> **需要超越文本生成的技能？** Claude 可以通过 Composio 连接 500+ SaaS 应用（包含 78 个预构建技能），执行真实操作如发送邮件、创建 Issue、发布 Slack 消息等。[了解如何使用 →](./connect/)
...
> 精选 **30+** 个实用 Claude Skills，按使用场景分类整理
...
- [Artifacts Builder](./artifacts-builder/) — 使用 React、Tailwind CSS、shadcn/ui 创建复杂多组件 claude.ai HTML artifacts 的工具套件。
...
- [Skill Share](./skill-share/) — 创建新 Claude 技能并使用 Rube 自动在 Slack 上分享，实现团队协作和技能发现。
...
通过 [Composio](https://composio.dev) 将 Claude 连接到 500+ SaaS 应用，包含 78 个预构建工作流技能。每个技能包含工具序列、参数指导、已知陷阱和快速参考表 — 全部基于 Composio API 的真实工具构建。
...
- **中文翻译**: [LessUp/awesome-claude-skills-zh](https://github.com/LessUp/awesome-claude-skills-zh)
