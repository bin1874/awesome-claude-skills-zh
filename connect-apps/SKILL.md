...
将 Claude 连接到 1000+ 应用。真正发送邮件、创建 issue、发布消息 - 不仅仅是生成关于它的文本。
...
1. 你要求 Claude 做某事
2. Composio 工具路由器找到正确的工具
3. 首次？你需要通过 OAuth 授权（一次性）
4. 操作执行并返回结果

## 故障排除

- **"插件未找到"** → 确保你运行了 `/plugin install composio-toolrouter`
